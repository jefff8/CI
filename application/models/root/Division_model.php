<?php
	...
	class Division_model extends CI_Model{
		...
		public function application($division_timestamp){
			$sql = "select id,工程名称,分部工程名称,发起时间,发起单位,监理单位 from 分部验收 where 工程时间戳=? and (工程单状态=? or 工程单状态=?)";
		...
		public function approval($division_timestamp){
			$sql = "select id,工程名称,工程单状态,分部工程名称,发起时间,发起单位,监理单位,验收时间 from 分部验收 where 工程时间戳=? and (工程单状态=? or 工程单状态=?)";
