...
for ($i= 0;$i< $nub4; $i++){
	...
	if ($result -> num_rows > 0) {
			$sqli = "update 分部验收  set  验收时间 = '".$acceptanceTime."',验收通知 = '".$filenames1."',会议照片 = '".$filenames2."',工程单状态 = '待审批',签到记录表='".$filenames3."',验收报告='".$filenames4."',验收通知说明='".$acceptText."',会议照片说明='".$meetingText."',签到记录表说明='".$signinText."',验收报告说明='".$reportText."' where id='".$selfId."'";
	}
